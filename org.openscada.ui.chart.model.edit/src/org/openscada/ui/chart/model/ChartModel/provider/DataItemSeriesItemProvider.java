...
public class DataItemSeriesItemProvider extends ItemDataSeriesItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
    ...
    {
        itemPropertyDescriptors.add ( createItemPropertyDescriptor ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (), getResourceLocator (), getString ( "_UI_DataItemSeries_lineColor_feature" ), getString ( "_UI_PropertyDescriptor_description", "_UI_DataItemSeries_lineColor_feature", "_UI_DataItemSeries_type" ), ChartPackage.Literals.DATA_ITEM_SERIES__LINE_COLOR, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null ) );
    }
