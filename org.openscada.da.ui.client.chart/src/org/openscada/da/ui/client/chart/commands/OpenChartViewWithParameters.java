...
public class OpenChartViewWithParameters extends AbstractChartHandler
{
    ...
    {
        final String connectionId = event.getParameter ( "org.openscada.da.ui.client.chart.connectionId" );
        final String connectionString = event.getParameter ( "org.openscada.da.ui.client.chart.connectionString" );
        final String itemId = event.getParameter ( "org.openscada.da.ui.client.chart.itemId" );
