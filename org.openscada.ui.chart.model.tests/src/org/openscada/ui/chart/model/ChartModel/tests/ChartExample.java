...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>ChartModel</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ChartExample
{
    ...
    public static void main ( String[] args )
    {
        ...
        if ( args.length == 0 )
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource ( URI.createURI ( "http:///My.chart" ) );
                Chart root = ChartFactory.eINSTANCE.createChart ();
